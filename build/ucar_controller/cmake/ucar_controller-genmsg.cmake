...
message(STATUS "ucar_controller: 0 messages, 4 services")
...
get_filename_component(_filename "/home/ucar/Desktop/ucar/src/ucar_controller/srv/GetMaxVel.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/Desktop/ucar/src/ucar_controller/srv/GetMaxVel.srv" ""
)

get_filename_component(_filename "/home/ucar/Desktop/ucar/src/ucar_controller/srv/SetMaxVel.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/Desktop/ucar/src/ucar_controller/srv/SetMaxVel.srv" ""
)

get_filename_component(_filename "/home/ucar/Desktop/ucar/src/ucar_controller/srv/GetBatteryInfo.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/Desktop/ucar/src/ucar_controller/srv/GetBatteryInfo.srv" "std_msgs/Header:sensor_msgs/BatteryState"
)

get_filename_component(_filename "/home/ucar/Desktop/ucar/src/ucar_controller/srv/SetLEDMode.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/Desktop/ucar/src/ucar_controller/srv/SetLEDMode.srv" ""
)
